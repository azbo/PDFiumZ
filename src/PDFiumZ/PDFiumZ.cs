// Built from PDFium 146.0.7643 headers
// Generated on: Mon, 19 Jan 2026 10:41:35 GMT
...
namespace PDFiumZ
{
    ...
    public unsafe partial class fpdf_doc
    {
        public partial struct __Internal
        {
            ...
            internal static extern __IntPtr FPDFBookmarkGetAction([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(CppSharp.Runtime.UTF8Marshaller))] string key);

            [SuppressUnmanagedCodeSecurity, DllImport("pdfium", EntryPoint = "FPDFAction_GetType", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint FPDFActionGetType(uint B);
            ...
            internal static extern uint FPDF_GetFileIdentifier(__IntPtr document, __IntPtr hHandle, __IntPtr buffer, uint buflen);
        ...
        /// </summary>
        public static global::PDFiumZ.FpdfActionT FPDFBookmarkGetAction(string key)
        {
            var ___ret = __Internal.FPDFBookmarkGetAction(key);
        ...
        /// </summary>
        public static uint FPDFActionGetType(uint B)
        {
            var ___ret = __Internal.FPDFActionGetType(B);
            return ___ret;
        }
        ...
        /// </summary>
        public static uint FPDF_GetFileIdentifier(global::PDFiumZ.FpdfDocumentT document, global::PDFiumZ.FpdfFormHandleT hHandle, __IntPtr buffer, uint buflen)
        {
            var __arg0 = document is null ? __IntPtr.Zero : document.__Instance;
            var __arg1 = hHandle is null ? __IntPtr.Zero : hHandle.__Instance;
            var ___ret = __Internal.FPDF_GetFileIdentifier(__arg0, __arg1, buffer, buflen);
            return ___ret;
        }
    ...
    public unsafe partial class fpdf_progressive
    {
        public partial struct __Internal
        {
            ...
            internal static extern int FPDF_RenderPageBitmapWithColorSchemeStart(__IntPtr bitmap, __IntPtr page, int start_x, int start_y, int size_x, int size_y, int rotate, int flags, __IntPtr page_object, __IntPtr pause);
        ...
        /// <para>details.</para>
        /// </summary>
        public static int FPDF_RenderPageBitmapWithColorSchemeStart(global::PDFiumZ.FpdfBitmapT bitmap, global::PDFiumZ.FpdfPageT page, int start_x, int start_y, int size_x, int size_y, int rotate, int flags, global::PDFiumZ.FpdfPageobjectT page_object, global::PDFiumZ.IFSDK_PAUSE pause)
        {
            var __arg0 = bitmap is null ? __IntPtr.Zero : bitmap.__Instance;
            var __arg1 = page is null ? __IntPtr.Zero : page.__Instance;
            var __arg8 = page_object is null ? __IntPtr.Zero : page_object.__Instance;
