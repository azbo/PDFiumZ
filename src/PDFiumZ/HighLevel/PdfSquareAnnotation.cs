...
/// <summary>
/// Represents a square/rectangle annotation in a PDF document.
/// Square annotations display a rectangle or square shape.
/// </summary>
public sealed class PdfSquareAnnotation : PdfAnnotation
{
    /// <summary>
    /// Creates a new square/rectangle annotation on the specified page.
    /// </summary>
    /// <param name="page">The page to add the annotation to.</param>
    /// <param name="bounds">The bounding rectangle of the square/rectangle.</param>
    /// <param name="borderColor">The border color in ARGB format (default: solid red). Set to 0 for no border.</param>
    ...
    /// <returns>A new <see cref="PdfSquareAnnotation"/> instance.</returns>
    ...
    public static PdfSquareAnnotation Create(
        PdfPage page,
        PdfRectangle bounds,
        ...
        double borderWidth = 1.0)
    {
        ...
        // Create square annotation (type 5)
        var handle = fpdf_annot.FPDFPageCreateAnnot(page._handle!, (int)PdfAnnotationType.Square);
        if (handle is null || handle.__Instance == IntPtr.Zero)
        {
            throw new PdfException("Failed to create square annotation.");
        }

        var annotation = new PdfSquareAnnotation(handle, page, -1);
    ...
    /// </summary>
    internal PdfSquareAnnotation(FpdfAnnotationT handle, PdfPage page, int index)
        : base(handle, page, PdfAnnotationType.Square, index)
    {
    }

    /// <summary>
    /// Sets the border (stroke) color of the rectangle.
    /// </summary>
    ...
    /// <summary>
    /// Sets the fill (interior) color of the rectangle.
    /// </summary>
    ...
    /// <summary>
    /// Gets the border (stroke) color of the rectangle.
    /// </summary>
    ...
    /// <summary>
    /// Gets the fill (interior) color of the rectangle.
    /// </summary>
