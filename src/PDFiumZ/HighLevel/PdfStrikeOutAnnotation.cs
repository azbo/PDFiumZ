...
public sealed class PdfStrikeOutAnnotation : PdfAnnotation
{
    ...
    /// <summary>
    /// Gets the quad points that define the strikeout regions.
    /// Each quad point represents a quadrilateral region (typically a text selection).
    /// </summary>
    /// <returns>An array of rectangles representing the strikeout regions.</returns>
    ...
    /// <summary>
    /// Sets the quad points that define the strikeout regions.
    /// Each rectangle is converted to a quadrilateral for the strikeout.
    /// </summary>
    /// <param name="rectangles">The rectangles to strike out.</param>
    ...
    /// <summary>
    /// Adds a rectangular region to the strikeout.
    /// </summary>
