...
namespace PDFiumZBindingsGenerator
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var releaseInfo = JsonSerializer.Deserialize<Release>(json);
            ...
            if (buildBindings)
            {
                ...
                // Version includes the revision segment and is used for the PDFiumZ package version.
            ...
            using (var writer = new StreamWriter(stream))
            {
                ...
                writer.Write("dotnet ./src/PDFiumZBindingsGenerator/bin/Release/net8.0/PDFiumZBindingsGenerator.dll ");
