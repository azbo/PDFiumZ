...
namespace FluentApi示例;

/// <summary>
/// PDFiumZ Fluent API 完整示例（中文版）
...
class Program
{
    ...
    {
        Console.WriteLine("\n" + new string('=', 50));
        Console.WriteLine("Fluent API 使用技巧:");
        Console.WriteLine(new string('=', 50));
        Console.WriteLine("1. 使用 .Content() 开始定义文档内容");
        Console.WriteLine("2. 使用 .Column() 创建垂直布局");
        Console.WriteLine("3. 使用 .Row() 创建水平布局");
        Console.WriteLine("4. 使用 .Text() 添加文本元素");
        Console.WriteLine("5. 使用 .Background() 设置背景色");
        Console.WriteLine("6. 使用 .Border() 添加边框");
        Console.WriteLine("7. 使用 .Padding() 设置内边距");
        Console.WriteLine("8. 使用 .AlignCenter() 等方法对齐元素");
        Console.WriteLine("\n更多信息请参阅:");
        Console.WriteLine("  - .workflow/docs/PDFiumZ/README.md");
        Console.WriteLine("  - .workflow/docs/PDFiumZ/src/PDFiumZ/API.md");
    }
    ...
    static void 创建简单文档()
    {
        ...
        // 加载中文字体
        var chineseFont = FontHelper.LoadChineseFont(document.UnderlyingDocument);
        document.WithFont(chineseFont);
