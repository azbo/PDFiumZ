# <img src="https://raw.githubusercontent.com/azbo/PDFiumZ/master/src/PDFiumZ/icon.png" width="48"> PDFiumZ [![NuGet](https://img.shields.io/nuget/v/PDFiumZ.svg?maxAge=60)](https://www.nuget.org/packages/PDFiumZ)
...
- 🚀 **[Quick Start & Examples](https://github.com/azbo/PDFiumZ/blob/master/docs/README.md)** - Get up and running in minutes
- 🖼️ **[Image Generation Guide](https://github.com/azbo/PDFiumZ/blob/master/docs/IMAGE_GENERATION.md)** - Convert PDF pages to images with one line of code
- 📝 **[Fluent API Guide](https://github.com/azbo/PDFiumZ/blob/master/docs/FLUENT_API.md)** - QuestPDF-style declarative document generation
- 📈 **[Performance Analysis](https://github.com/azbo/PDFiumZ/blob/master/PERFORMANCE.md)** - Memory and speed benchmarks
- 📜 **[Changelog](https://github.com/azbo/PDFiumZ/blob/master/CHANGELOG.md)** - Recent updates and breaking changes
- 🗺️ **[Roadmap](https://github.com/azbo/PDFiumZ/blob/master/ROADMAP.md)** - Future plans and upcoming features
...
Apache-2.0. See [LICENSE](https://github.com/azbo/PDFiumZ/blob/master/LICENSE).
...
<div align="center">
  <img src="https://raw.githubusercontent.com/azbo/PDFiumZ/master/docs/wechat-pay-qr.png" width="200" alt="WeChat Pay">
  <img src="https://raw.githubusercontent.com/azbo/PDFiumZ/master/docs/alipay-qr.png" width="200" alt="Alipay">
</div>
